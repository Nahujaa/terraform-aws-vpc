...
resource "aws_flow_log" "this" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "ce6b5120-5cd6-4770-acfc-a0587ffa0f9c"
  })
}
...
resource "aws_cloudwatch_log_group" "flow_log" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "7486a183-dfe0-4bc4-aca7-8b7009065a86"
  })
}
...
resource "aws_iam_role" "vpc_flow_log_cloudwatch" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "fd02a447-9996-47e3-bebe-ce366b80955b"
  })
}
...
resource "aws_iam_policy" "vpc_flow_log_cloudwatch" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "cb08e4e0-cdcc-4ef5-964d-59f44cc0d478"
  })
}
