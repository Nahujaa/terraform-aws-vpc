...
resource "aws_flow_log" "this" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "bca567ee-56d4-4803-b494-a9aa439002b3"
  })
}
...
resource "aws_cloudwatch_log_group" "flow_log" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "d6a322f7-8c46-457b-ade2-09e05e78130e"
  })
}
...
resource "aws_iam_role" "vpc_flow_log_cloudwatch" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "0dd9da1a-dd4f-452b-be94-2538bac14997"
  })
}
...
resource "aws_iam_policy" "vpc_flow_log_cloudwatch" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "9a028046-d41e-4d83-bdea-f42307aaaa9e"
  })
}
