...
resource "aws_flow_log" "this" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "90440c98-a4ae-44fb-b2c3-94ca00578c82"
  })
}
...
resource "aws_cloudwatch_log_group" "flow_log" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "ef5abfe4-bf51-4fda-b7b5-56873ed1a211"
  })
}
...
resource "aws_iam_role" "vpc_flow_log_cloudwatch" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "0fa10b4a-c634-44a7-b741-7b17b8acfa3b"
  })
}
...
resource "aws_iam_policy" "vpc_flow_log_cloudwatch" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "f666bcbb-00d3-48bc-b4d6-a3858ffe397c"
  })
}
