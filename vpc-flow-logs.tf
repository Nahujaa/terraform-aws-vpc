...
resource "aws_flow_log" "this" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "44bf4db8-ec2f-47dc-a273-770985499d28"
  })
}
...
resource "aws_cloudwatch_log_group" "flow_log" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "f6872ffa-0325-403a-91a1-094722fab06b"
  })
}
...
resource "aws_iam_role" "vpc_flow_log_cloudwatch" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "3a70c36c-afa0-42b3-9f6e-86c4d26f89f8"
  })
}
...
resource "aws_iam_policy" "vpc_flow_log_cloudwatch" {
  ...
  tags = merge(var.tags, var.vpc_flow_log_tags, {
    Env       = "prod"
    yor_trace = "b1c3198a-d6f3-4ec0-bd37-79639dff74de"
  })
}
