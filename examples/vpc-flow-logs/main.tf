...
module "s3_bucket" {
  ...
  tags = merge(local.tags, {
    Env       = "prod"
    yor_trace = "97aaf60e-0f5d-47cd-bc55-b2a268a6a220"
  })
}
...
resource "aws_cloudwatch_log_group" "flow_log" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "7a56dea6-323d-4a2b-af99-0c436723e148"
  }
}
...
resource "aws_iam_role" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "d35ae835-25dd-4e87-bf28-64fb452a2997"
  }
}
...
resource "aws_iam_policy" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "84fab8bb-2fda-4e8f-bf60-d005a7b3de9b"
  }
}
