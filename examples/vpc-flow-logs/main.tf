...
module "s3_bucket" {
  ...
  tags = merge(local.tags, {
    Env       = "prod"
    yor_trace = "adae2e0b-3679-4fe5-8734-3a6ae44707d2"
  })
}
...
resource "aws_cloudwatch_log_group" "flow_log" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "2407ba7d-97ed-49f0-a682-2972ae964612"
  }
}
...
resource "aws_iam_role" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "a03328b9-73da-4ccf-b7e1-1abe2cbfc9b0"
  }
}
...
resource "aws_iam_policy" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "cfaae668-e7c2-41c6-a947-e9f534e59bfa"
  }
}
