...
module "s3_bucket" {
  ...
  tags = merge(local.tags, {
    Env       = "prod"
    yor_trace = "26cb3d1b-e762-44d2-921c-7d89ff79fc8f"
  })
}
...
resource "aws_cloudwatch_log_group" "flow_log" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "54b46118-bda3-42ce-aa0c-55f5addc957c"
  }
}
...
resource "aws_iam_role" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "45106fed-6fee-4f79-90b1-cd747f4ff659"
  }
}
...
resource "aws_iam_policy" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "ef6e124c-5323-4723-850a-02736a71bfc1"
  }
}
