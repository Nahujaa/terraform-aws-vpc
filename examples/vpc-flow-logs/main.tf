...
module "s3_bucket" {
  ...
  tags = merge(local.tags, {
    Env       = "prod"
    yor_trace = "bc8c2cb0-8639-40af-8102-aa448a77a312"
  })
}
...
resource "aws_cloudwatch_log_group" "flow_log" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "a9b54acd-b133-45f7-a173-0b6f894c732e"
  }
}
...
resource "aws_iam_role" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "00434b61-e023-4919-9eb7-1146db7bd895"
  }
}
...
resource "aws_iam_policy" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "2b04f632-9541-48f5-aebe-5252f497bd1e"
  }
}
