...
module "s3_bucket" {
  ...
  tags = merge(local.tags, {
    yor_trace = "13b396b0-b494-4432-82c6-948e04418deb"
  })
}
...
resource "aws_cloudwatch_log_group" "flow_log" {
  ...
  tags = {
    yor_trace = "0585d449-8f0d-427e-ae79-a172c6d5dd5e"
  }
}
...
resource "aws_iam_role" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    yor_trace = "3dd43659-c695-4347-9cea-fd69a83dbabe"
  }
}
...
resource "aws_iam_policy" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    yor_trace = "28ed3ca4-4085-4f91-baa8-7ec77ee0d5aa"
  }
}
