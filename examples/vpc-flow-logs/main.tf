...
module "s3_bucket" {
  ...
  tags = merge(local.tags, {
    Env       = "prod"
    yor_trace = "b8716976-09a1-4b55-8fc5-a939cd3214de"
  })
}
...
resource "aws_cloudwatch_log_group" "flow_log" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "ae98ef04-c0ec-4b09-88b6-fc99ee0438d4"
  }
}
...
resource "aws_iam_role" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "6f15f9c1-783c-4b6c-ac3a-acb4c3eb712c"
  }
}
...
resource "aws_iam_policy" "vpc_flow_log_cloudwatch" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "96608c30-a8aa-49e4-a2db-6d80c36096cf"
  }
}
